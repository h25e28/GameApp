...
import com.example.s183363.kadai_app.controllers.BaseActivity;
...
public class BaseView extends View {
    ...
    // 画像の描画
    protected void drawImageWithoutScale(int x, int y, int xSize, int ySize, Bitmap bitmap, ImageView imageView) {
    ...
    // 画像の描画
    protected void drawImage(int x, int y, int xSize, int ySize, Bitmap bitmap, ImageView imageView) {
        if (canvasBaseX + canvasWindowWidth-1 < x || x + xSize-1 < canvasBaseX) {
            return;
        }
        if (canvasBaseY + canvasWindowHeight-1 < y || y + ySize-1 < canvasBaseY) {
